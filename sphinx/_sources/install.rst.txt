...
If :code:`ocp-plugin-deps` is available in your opam repository, you can just call::

  opam install ocp-plugin-deps

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`ocp-plugin-deps` in a directory.
