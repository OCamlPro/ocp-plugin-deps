...
# -*- coding: utf-8 -*-
#
# ocp-plugin-deps documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ocp-plugin-deps.tex', 'ocp-plugin-deps Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ocp-plugin-deps', 'ocp-plugin-deps Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ocp-plugin-deps', 'ocp-plugin-deps Documentation',
     author, 'ocp-plugin-deps', 'One line description of project.',
     'Miscellaneous'),
]
