...
val archive :
  ?preds:predicates -> MetaTypes.t -> string list (* already splitted *)
val requires :
  ?preds:predicates -> MetaTypes.t -> string list (* already splitted *)
val plugin :
  ?preds:predicates -> MetaTypes.t -> string list
...
val precs_native : preconditions
